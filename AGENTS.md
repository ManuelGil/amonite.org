...
Prefer the website over growing maintainer docs. Delete duplicated product narrative from `docs/`. No roadmaps. Reddit for discussion. No support email on the site. Credit Manuel Gil. Preserve curated assets and `ATTRIBUTION.md`.

When docs and code disagree about website behaviour, fix the code or revise the docs deliberately.
